    ...
    if type == 'xui':
        ...
        if connectionLinks['success']:
            ...
            additionalText = ("\r\n\r\n<b>При первом подключении</b> ваш ключ может дойти на все серверы с задержкой до 10 минут." \
                              "\r\nПожалуйста, попробуйте подождать <b>10 минут</b> и переподключиться (по-новой ключ добавлять не нужно, достаточно отключить и включить соединение впн в приложении)")
