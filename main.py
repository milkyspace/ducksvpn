...
async def Init(call: types.CallbackQuery):
    ...
    await bot.send_message(chat_id=user_dat.tgid, text=e.emojize(f"Запрос отправлен. Пожалуйста, дождитесь сообщения с инструкцией :winking_face:"), parse_mode="HTML")
