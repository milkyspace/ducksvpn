...
async def main_buttons(user: User, wasUpdate = None):
    ...
    if user.subscription != "none":
        ...
        Butt_main.add(types.KeyboardButton(e.emojize(f"Наши преимущества :wrapped_gift:")), types.KeyboardButton(e.emojize(f"Пригласить :wrapped_gift:")), types.KeyboardButton(e.emojize(f"Помощь :heart_hands:")))
